...
Version  : 0.25
Release  : 40
URL      : https://github.com/rhinstaller/pocketlint/archive/0.25/pocketlint-0.25.tar.gz
Source0  : https://github.com/rhinstaller/pocketlint/archive/0.25/pocketlint-0.25.tar.gz
...
%prep
%setup -q -n pocketlint-0.25
cd %{_builddir}/pocketlint-0.25
pushd ..
cp -a pocketlint-0.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720048196
